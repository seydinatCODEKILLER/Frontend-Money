...
import { Bell, TrendingUp, AlertTriangle, Zap, CheckCircle2 } from 'lucide-react'
...
import type { Alert } from '@/features/alerts/api/alert.types'
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {alert.amount && (
                      <p className="text-xs text-muted-foreground">
                        Montant: {alert.amount.toLocaleString('fr-FR', {
                          style: 'currency',
                          currency: 'EUR'
                        })}
                        {alert.threshold && ` / ${alert.threshold.toLocaleString('fr-FR', {
                          style: 'currency',
                          currency: 'EUR'
                        })}`}
                      </p>
